...
export const capabilities = [
  ...
  },
  {
    title: '算法研发',
    subtitle: 'Algorithm',
    description: '主持大创项目，提出基于超图的深度矩阵分解社区发现算法，成果包括发明专利1项、高水平论文在审。',
...
export const projects = [
  ...
  },
  {
    id: 'deep-mf',
    title: '深度矩阵分解社区发现研究',
    description: '主持大创项目，提出基于超图的深度矩阵分解方法，引入解码组件与新型范数约束，在多个公开数据集平均准确率达63.4%。',
...
export const aboutData = {
  ...
  growth: [
    { year: '2023', event: '主持大创项目，提出基于超图的深度矩阵分解社区发现算法，成果包括发明专利1项' },
  ...
  campusProjects: [
    {
      ...
      role: '核心成员 · 算法改进与编程实现',
      description: '参与非负矩阵分解的社区发现研究，负责算法的研究改进与编程实现。针对现有算法仅有编码过程、无法捕捉更深层节点信息的问题，提出一种自编码结构，将得到的信息解码成原始信息，提高了算法潜在信息的挖掘能力。同时在目标函数中添加新型范数约束，解决常用范数约束鲁棒性差的问题。',
      result: '改进算法在多个公开数据集平均准确率达63.4%，1件发明专利在审，高水平论文准备发表',
    ...
    projects: [
      {
        ...
        subtitle: '基于超图的非负矩阵分解的社区发现研究',
        period: '2023.03 - 至今',
        role: '项目核心负责人',
        description: '致力于开发基于超图的深度矩阵分解社区发现算法。核心突破在于摒弃传统方法仅依赖邻接矩阵构建原始矩阵（局限于捕捉节点的一维信息），引入超图概念捕捉更为复杂和多元的信息维度。设计了解码组件，能够精确地将编码后的矩阵重新构建为原始矩阵。对约束项进行了优化，显著降低算法对数据中噪音的敏感度。',
        result: '发明专利1项在审，高水平论文准备发表',
      },
      {
        title: '参与谢小良教授科研团队',
        subtitle: '国家社科基金重点项目',
